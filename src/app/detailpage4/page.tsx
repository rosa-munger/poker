...
export default function DetailPage4() {
  ...
  const getImagePath = () => {
    if (language === "tw") {
      return "/image/home/sliders/click-banner-tw/16en-detail-BAXvfGL_.jpg";
    } else if (language === "cn") {
      return "/image/home/sliders/click-banner-cn/16en-detail-BAXvfGL_.jpg";
    }
    return "/image/home/sliders/click-banner/16en-detail-BAXvfGL_.jpg";
  };
